...
export default function MonthlyTable({ monthlyUsage, provider }) {
          ...
          <tbody className="divide-y divide-[var(--color-outline)]">
            {monthlyUsage.map((m, i) => (
              ...
              >
                ...
                <td className="px-3 py-3 text-right font-medium text-gray-900">{formatMoney(m.totalRecharge, { zeroAsDash: true })}</td>
                <td className="px-3 py-3 text-right text-gray-600">{formatMoney(m.usedElectricity)}</td>
                ...
                <td className="px-3 py-3 text-right text-gray-500">{formatMoney(m.demandCharge, { zeroAsDash: true })}</td>
                <td className="px-3 py-3 text-right text-gray-500">{formatMoney(m.meterRent, { zeroAsDash: true })}</td>
                <td className="px-3 py-3 text-right text-gray-500">{formatMoney(m.vat, { decimals: 2, zeroAsDash: true })}</td>
                ...
                <td className="px-3 py-3 text-right text-gray-700">{formatMoney(m.totalUsage, { zeroAsDash: true })}</td>
                <td className="px-3 py-3 text-right">
